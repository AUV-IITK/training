...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.product = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.hardware_rev = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.firmware_rev = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.firmware_date = str[start:end].decode('utf-8', 'rosmsg')
      else:
